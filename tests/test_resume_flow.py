...
def make_settings(tmp_path: Path) -> Settings:
    ...
    return Settings(
        ...
        opera_gx_executable_path=None,
        opera_gx_user_data_dir=str(browser_state_dir / "opera_gx_user_data"),
        opera_gx_clone_profile_when_running=True,
        download_media_assets=False,
        vpn_rotate_every_n=0,
        vpn_rotate_command=None,
        vpn_rotate_wait_seconds=0.0,
        reels_tab_max_items=0,
        reels_tab_max_scroll_rounds=0,
        skip_media_shortcodes=frozenset(),
        skip_media_urls=frozenset(),
